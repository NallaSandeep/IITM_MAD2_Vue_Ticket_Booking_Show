      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-md-9 col-lg-6 col-xl-5">
          <section class="jumbotron text-center">
            <div class="container">
              <h1 class="jumbotron-heading">Theatre Registration</h1>
              <h2 class="jumbotron-heading">Join the Stage</h2>
              <img
    ...
    async register(e) {
      ...
      if (!this.errors.length) {
        ...
        const request = new Request(
          "http://localhost:5000/api/" + userid + "/theatre",
          {
            method: "POST",
            body: JSON.stringify({
          ...
          .then((response) => {
            if (response.status !== 201) {
              return response.json().then((errorData) => {
                ...
                const errorMessage =
                  errorData.message || "Unable to create theatre";
